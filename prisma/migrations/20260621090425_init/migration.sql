-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'SELLER', 'STUDENT');

-- CreateEnum
CREATE TYPE "BookCopyStatus" AS ENUM ('AVAILABLE', 'BORROWED', 'RESERVED', 'DAMAGED', 'LOST');

-- CreateEnum
CREATE TYPE "BorrowStatus" AS ENUM ('ONGOING', 'RETURNED', 'OVERDUE');
...
CREATE TABLE "Book" (
    ...
    "isForBorrow" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "BorrowRecord" ADD CONSTRAINT "BorrowRecord_bookCopyId_fkey" FOREIGN KEY ("bookCopyId") REFERENCES "BookCopy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
